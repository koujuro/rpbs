...
class AuthTokenGenerator
{
    ...
    /**
     * Create the token for database_assets login
     *
     * @param string $endpoint The database_assets hostname with port number specified
     *                         (e.g., host:port)
     * @param string $region The region where the database_assets is located
